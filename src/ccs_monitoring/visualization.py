...
def _friendly_variable_name(variable_name: str) -> str:
    mapping = {
        ...
        "temporal_ml_constrained": "Temporal Support Assimilation",
        "temporal_leave_one_out_constrained": "Temporal Leave-One-Out Support",
        "temporal_probability": "Temporal Probability",
        "temporal_uncertainty": "Temporal Uncertainty",
        "wave_temporal_constrained": "C02Shift Support",
        "wave_temporal_probability": "C02Shift Probability",
        "wave_temporal_uncertainty": "C02Shift Uncertainty",
        "wave_temporal_predicted_residual": "C02Shift Predicted Residual",
        "wave_temporal_heldout_constrained": "C02Shift Held-Out Support",
        "wave_temporal_heldout_probability": "C02Shift Held-Out Probability",
        "wave_temporal_heldout_uncertainty": "C02Shift Held-Out Uncertainty",
        "wave_temporal_heldout_predicted_residual": "C02Shift Held-Out Residual",
